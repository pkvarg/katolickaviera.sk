      ...
      {language === 'slovak' && (
        <>
          <main className='hero-bg relative'>
            <LanguageBar />
            <h1 className='text-title text-center text-[25px] lg:text-[40px] pt-[15%] lg:pt-[10%] font-bold leading-[35px] lg:leading-[50px]'>
          ...
          <section className='bg-black px-4 lg:px-8 pt-8 pb-16 '>
            ...
            <div className='text-white text-justify'>
              ...
              <span id='verse-ref'> Prvý Korinťanom 10:20-22</span>
              <span className='italic'>
                {' '}
                Preto, moji milovaní, utekajte pred modloslužobníctvom!
              </span>
              <span id='verse-ref'> Prvý Korinťanom 10:14</span>
            </div>
            ...
            <div className='text-white  text-justify'>
              ...
              <span id='verse-ref'> Matúš 12:46</span>
            </div>
          ...
          <section className='bg-white text-black px-4 lg:px-8 pt-8'>
            ...
            <div className='text-justify'>
              ...
              <span id='verse-ref'> Matúš 22:37</span>
              <span className='italic'>
                {' '}
            ...
            <div className='text-justify'>
              ...
              <span id='verse-ref'> Zjavenie Jána 22:8-9</span>
              <span className='italic'>
                {' '}
            ...
            <div className='text-black text-justify'>
              ...
              <span id='verse-ref'> Prvý Jánov 2:4</span>
              <span>
                {' '}
