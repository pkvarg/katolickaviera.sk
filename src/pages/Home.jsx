...
const Home = ({ lng, setLng }) => {
  ...
  const apiUrl = 'https://hono-api.pictusweb.com/api/visitors/kv/increase'
  //const apiUrl = 'http://localhost:3013/api/visitors/kv/increase'
        ...
        <>
          <main className="hero-bg relative">
            ...
            <div className="text-[#FFFFFF] text-[22.5px] flex flex-col items-center">
              ...
              <span className="italic text-center">A poznáte pravdu a pravda vás vyslobodí.</span>
            ...
            <div className="hidden lg:flex flex-col absolute bottom-0 lg:bottom-4 xl:-bottom-8 l-0 px-8">
              ...
              <h2 className="text-white text-[22.5px] text-justify">
                <span className="italic">
                  Ak sa niekto obráti k duchom mŕtvych a k jasnovidcom a smilne sa im zapredá, ja
                  sám obrátim svoju tvár proti tej osobe a odstránim ju z jej ľudu.
                </span>
                <span className="text-[15px]"> Levitikus 20:6 </span>
                Umožňuje to apokryfná kniha Makabejských, ktorá je v rozpore s Mojžišovým zákonom.
                (viac v sekcii <a href="/biblia">Biblia)</a>
              </h2>
            </div>
          </main>
          <section className="bg-black px-4 lg:px-8 pt-8 pb-16">
            ...
            <h2 className="text-white text-[22.5px] text-justify">
              <span className="italic">
                Ale čo (pohania) obetujú, to obetujú démonom, a nie Bohu. A ja nechcem, aby ste boli
                spoločníkmi démonov. Nemôžete piť z kalicha Pánovho aj z kalicha démonov: nemôžete
                mať podiel pri stole Pánovom aj pri stole démonov. Či chceme azda rozhnevať Pána?
              </span>
            ...
            <h2 className="text-white text-[22.5px] text-justify">
              <span className="italic">
                Preto ako skrze jedného človeka (Adama) hriech prišiel na svet a skrze hriech smrť -
                tak smrť prišla na všetkých ľudí, pretože všetci zhrešili.
              </span>
            ...
            <h2 className="text-white text-[22.5px] text-justify">
              <span className="italic">
                Keď ešte hovoril k zástupom, ajhľa, Jeho matka a bratia stáli vonku a žiadali si
                hovoriť s Ním.
              </span>
            ...
            <h2 className="text-white text-[22.5px] text-justify">
              <span className="italic">
                Každá reč Božia je prečistená. Nepridávaj nič k Jeho slovám, aby ťa nestrestal a
                neoznačil za klamára.
              </span>
              <span className="text-[15px]"> Príslovia 30:5-6</span>
              <span className="italic">
                {' '}
                Nefalšujeme slovo Božie, ale zjavujeme pravdu, a tak sa odporúčame každému ľudskému
                svedomiu pred Bohom.{' '}
              </span>
          ...
          <section className="bg-white text-black px-4 lg:px-8 pt-8">
            ...
            <h2 className="text-[25px] text-justify">
              ...
              <span className="italic"> Nik neprichádza k Otcovi, ak len nie skrze mňa.</span>
            ...
            <h2 className=" text-[22.5px] text-justify">
              <span className="italic">
                Neurobíš si vyrezávanú modlu ani podobu ničoho, čo je na nebi hore, čo je na zemi
                dolu, alebo čo je vo vode pod zemou! Nebudeš sa im klaňať ani im slúžiť, lebo ja som
                Hospodin, tvoj Boh, Boh horliaci.
              </span>
            ...
            <h2 className=" text-[22.5px] text-justify">
              <span className="italic">
                Keď som to počul a videl, padol som k nohám anjelovi, ktorý mi to ukázal, a klaňal
                som sa mu. On mi však povedal: Pozri, nie tak! Som spoluslužobníkom tvojím, tvojich
                bratov, prorokov a tých, ktorí zachovávajú slová tejto knihy. Bohu sa klaňaj!
              </span>
            ...
            <h2 className="text-[22.5px] text-justify ">
              <span className="italic">
                I riekol Pán v noci vo videní Pavlovi: Neboj sa, len hovor a nemlč. I zostal tam rok
                a šesť mesiacov a vyučoval medzi nimi slovu Božiemu.
              </span>
              <span className="text-[15px]"> Skutky apoštolov 18:9,11</span>
              <span className="italic">
                {' '}
                A keď otvoril piatu pečať, videl som pod oltárom duše zamordovaných pre slovo Božie
                a pre svedectvo, ktoré vydávali.
              </span>
              <span className="text-[15px]"> Zjavenie Jána 6:9</span>
            </h2>

            <h1 className="text-title text-center text-[25px] lg:text-[30px] pt-8">
              Čo hovorí Božie Slovo o cirkevných tradíciách, ktoré sa od neho odchyľujú?
            </h1>
            <h2 className="text-black text-[22.5px] text-justify">
              <span className="italic">
                Darmo ma však uctievajú, keď ľudským príkazom učia ako učeniam (Božím). Opustili ste
                prikázanie Božie a pridŕžate sa podania ľudského. Potom im povedal: Pekne-krásne
                rušíte prikázanie Božie, aby ste zachovávali svoje podanie.
              </span>
              <span className="text-[15px]"> Marek 7:7-9</span>
              <span className="italic">
                {' '}
                Ak vy zostanete v mojom slove, ste naozaj moji učeníci. A poznáte pravdu a pravda
                vás vyslobodí.
              </span>
            ...
            <h2 className="text-black text-[22.5px] text-justify">
              <span className="italic">
                Kto hovorí: Poznám Ho, ale nezachováva Jeho prikázania, je klamár a niet v ňom
                pravdy.
              </span>
              <span className="text-[15px]"> Prvý Jánov 2:4</span>
              <span>
                {' '}
                Prevádzkuješ nemanželský vzťah? Žiadostivo hľadíš na ženy? Berieš Meno Božie
                nadarmo? Neži vo falošnej istote spasenia! Ak zotrvávaš vedome v hriechu, tvoja
                viera je mŕtva, zapieraš tým Ježiša a On ťa má za klamára.
                <span className="italic">
                  {' '}
                  Nie každý, kto mi hovorí: Pane, Pane! vojde do kráľovstva nebeského, ale ten, kto
                  činí vôľu môjho Otca nebeského.{' '}
                </span>
            ...
            <h2 className="text-[22.5px] py-10 text-justify">
              Prajem ti, aby si spoznal pravdu, bol oslobodený od tradícií a tak si sa raz mohol
              čistý postaviť pred Boha ako Jeho verný služobník.
            </h2>
          </section>
        </>
      )}
