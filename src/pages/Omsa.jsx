...
const Omsa = () => {
  return (
    <>
      ...
      {/* black lg and mob OK */}
      <section className='bg-black text-white'>
        <div className='text-justify text-[25px] flex flex-col gap-2 pt-4 pb-16 mx-8'>
          <p>
      ...
      <section className='flex flex-col mt-8 mx-8 pb-4'>
        ...
        <p className='text-[25px] text-justify my-4'>
      ...
      <section className='hidden lg:flex justify-center mx-4 gap-8 pt-8 pb-16'>
        <div className='w-[50%] border flex flex-col items-center mx-4'>
          ...
          <div className='text-[25px] font-semibold flex flex-col gap-4 mt-8 mx-4'>
            <p>
      ...
      {/* lg and mob OK */}
      <section className=''>
        <div className='text-justify text-[25px] flex flex-col gap-2 mt-4 mx-8 pb-16'>
          <p>
      ...
      <section className='bg-black text-white'>
        <div className='text-justify text-[25px] flex flex-col gap-2 pt-16 pb-16 mx-8'>
          <h1 className='text-title text-center text-[35px] pb-4'>
            Prijímanie
          </h1>
          <p>
